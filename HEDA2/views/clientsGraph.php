...
$DataSet->SetXAxisName("Month of the year");
 ...
 $Test = new pChart(878, 250);  
 $Test->drawGraphAreaGradient(10,10,10,10,TARGET_BACKGROUND);  
  
 // Prepare the graph area  
 $Test->setFontProperties("fonts/tahoma.ttf",8);  
 $Test->setGraphArea(100,40,770,200);  
 ...
 $Test->setFontProperties("../Fonts/tahoma.ttf",8);  
 $Test->drawLegend(770,5,$DataSet->GetDataDescription(),0,0,0,0,0,0,255,255,255,FALSE);  
