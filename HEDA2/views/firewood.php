                ...
                <div id="tooplate_menu">
                    <ul>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="firewood.php">Fire Wood</a>
                            </li>
                            <li>
                                <a href="charcoal.php">Charcoal</a>
                            </li>
                        </ul>
                        </li>
                        <li>
            ...
            <div id="tooplate_main">
                <div id="tooplate_content" >
                    ...
                    <div  style="float: right">
                        <?php
                        $file = 'List of Household Firewood use.pdf';
                        $excel = "Excel.xlsx";
                        ?>
                    ...
                    <?php
                    $array = $mod->getTotalFirewoodConsumption();
