                        ...
                        <div class="tab-pane" id="tabPane1">
                            ...
                            <div class="tab-page" id="tabPage1">
                                ...
                                <table border='0' cellspacing='5' cellpadding='5' align='center' width='600'>
                                    ...
                                    <p1>First Name</p1>
                                    <br>
                                    <input type='text' name='first_name' value='<?php echo $first_name ?>' size='50' class='heighttext' readonly />
                                    </td>                            

                                    <td>
                                    <p1>Second Name</p1>
                                    <br>
                                    <input type='text' name='second_name' value='<?php echo $second_name ?>' size='50' class='heighttext' readonly/>
                                    </td>
                                    <td>
                                    <p1>Last Name </p1>
                                    <br>
                                    <input type='text' name='last_name' value='<?php echo $last_name ?>' size='50' class='heighttext' readonly />
                                    ...
                                    <p1>Gender</p1>
                                    <br>
                                    <input type='text'  name='gender' class='heighttext' value='<?php echo $gender ?>' size="50" readonly/>

                                    </td>
                                    <td>
                                    <p1>National ID/Passport No </p1><br>
                                    <input type='text' name='passport' value='<?php echo $passport ?>' size='50' class='heighttext' readonly/>
                                    ...
                                    <br>
                                    <input type='text' name='country' class='heighttext' value='<?php echo $country ?>' size='50' readonly/>

                                    </td>
                                    <td>                                  
                                    <p1>Region/Province</p1>
                                    <br>
                                    <input type='text' name='region' class='heighttext' value='<?php echo $province ?>' size='50' readonly/>
                                    </td>
                                    <td>
                                    <p1>County</p1>
                                    <br>
                                    <input type='text' name='county' class='heighttext' value='<?php echo $county ?>' size='50' readonly/>
                                    </td>
                                    </tr>
                                    <tr>                                  
                                        <td>
                                    <p1>District </p1>
                                    <br>
                                    <input type='text' name='district' value='<?php echo $district ?>' size='50' class='heighttext'  readonly/>
                                    ...
                                    <br>
                                    <input type='text' name='division' value='<?php echo $division ?>' size='50'  class='heighttext' readonly/>
                                    </td>
                                    <td >
                                    <p1>
                                        Location 
                                    ...
                                    <br>
                                    <input type='text' name='location' value='<?php echo $location ?>' size='50'  class='heighttext' readonly/>
                                    </td>
                                    </tr>
                                    <tr>
                                        <td >
                                    ...
                                    <br>
                                    <input type='text' name='nearest_town' value='<?php echo $nearest_town ?>' size='50'  class='heighttext' readonly/>
                                    </td>
                                    <td >
                                    <p1>
                                        GPS Location
                                    ...
                                    <br>
                                    <input type='text' name='gps' value='<?php echo $gps; ?>' size='50'  class='heighttext' readonly/>
                                    </td>
                                    </tr>
                                    <tr>
                                        <td bgcolor='#F0F8FF'>
                                    ...
                                    <br>
                                    <input type = 'text' name = 'postal_address' value = '<?php echo $postal_address ?>' size = '50' class = 'heighttext' readonly />
                                    ...
                                    <br>
                                    <input type='text' name='postal_town' value='<?php echo $postal_town ?>' size='50' class='heighttext' readonly/>
                                    </td>
                                    <td>
                                    <p1>
                                        Mobile Number 
                                    </p1><br>
                                    <input type='text' name='mobile' value='<?php echo $mobile ?>' size='50' class='heighttext' readonly/>
                                    </td>                                   
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <input type='text' name='email' value='<?php echo $email ?>' size='50' class='heighttext' readonly/>
                                    </td>
                                    </tr>
                                    </tbody>
                                </table>
                            ...
                            <div class="tab-page" id="tabPage2" >
                                ...
                                <table border="0" cellspacing="5" cellpadding="5" align="center" width="600">
                                    ...
                                    <br>
                                    <select name="marital_status" class="heighttext" value="<?php echo $marital_status ?>" disabled>
                                    ...
                                    <br>
                                    <input type="text" name="household_head" value="<?php echo $household_head ?>" size="50" class="heighttext" readonly/>
                                    </td>
                                    <td>
                                    <p1>Size of Family <span class="error">*</span></p1><br>
                                    <input type="text" name="family_size" value="<?php echo $family_size ?>" size="50" class="heighttext" readonly/>
                                    </td>
                                    ...
                                    <br>
                                    <input type="text" name="rooms" value="<?php echo $rooms ?>" size="50" class="heighttext" readonly/>
                                    </td>
                                    <td valign="top">
                                    ...
                                    <textarea name="building_materials" rows="5" cols="30" readonly><?php echo $building_materials; ?></textarea>
                                    </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    <p1>Sources of Livelihood/Income <span class="error">*</span></p1><br>
                                    <textarea name="income_sources" rows="5" cols="30" readonly><?php echo $income_sources; ?></textarea>
                                    </td>
                                    <td valign="top">
                                    <p1>Main Source of Livelihood/Income <span class="error">*</span></p1><br>
                                    <input type="text" name="main_income_source" value="<?php echo $main_income_source; ?>" size="50" class="heighttext" readonly/>
                            ...
                            <div class="tab-page" id="tabPage3">
                                ...
                                <table border="0" cellspacing="5" cellpadding="5" >
                                    ...
                                    <select name="cooking_frequency" class="heighttext" disabled>
                                    ...
                                    <select name="cooking_type" class="heighttext" disabled>
                                    ...
                                    <textarea name="lighting_methods" rows="7" cols="40" readonly><?php echo $lighting_methods; ?></textarea>

                                    </td>
                                    <td valign="top">
                                    <p1><strong>Lighting Duration per Day </strong></p1><br>
                                    <select name="lighting_duration" class="heighttext" disabled>
                                    ...
                                    <input type="text" name="rooms_lit" value="<?php echo $rooms_lit; ?>" size="50" class="heighttext" readonly/>
