...
$message = $description = $date_added = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['submit-system-message'])) {
        ...
        if (!empty($message) && !empty($description)) {
            $model = new Messages();
            if (($model->addSystemMessage($message, $description, $date_added) > 0)) {
...
<html>
    <head>
        ...
        <meta charset="UTF-8">
        <title>New System Message Addition</title>
        ...
        <div id="tooplate_wrapper">
            ...
            <div id="tooplate_main">
                <div id="tooplate_content_new_client" >
                    ...
                    <br>
                    <br>
                    <p2>Fill in Details of New System Message. Mandatory Fields are marked <span class="error">*</span></p2>
                </div>
