...
<div class="bs-example">
    ...
    <div class="tab-content">
        <div id="sectionA" class="tab-pane fade in active">
            <h3>EAR News Letters</h3>
        <?php
        require_once("connect.php");
        $result = mysql_query("SELECT * FROM file_details");
        ...
        <?php
        require_once("connect.php");
        $result = mysql_query("SELECT * FROM news_updates");
        while($row = mysql_fetch_array($result))
         {
            ...
            echo "<p>"; echo "$newstitle </p>"; 
            echo "<p> $newsbody";
            ?> <a href= "<?php echo $filepath; ?>">&emsp;Download the full report here</a> <?php echo "</p>";
