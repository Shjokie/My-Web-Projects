...
<div id="wrapper">
	...
	<div class="container">
			...
			<strong><p><h3>Privacy policy</h3></p>
			<p>1. Introduction</p></strong>
			<ul>
			...
			<li>We will ask you to consent to our use of cookies in accordance with the terms of this policy when you first visit our website. / By using our website and agreeing to this policy, you consent to our use of cookies in accordance with the terms of this policy.</li>
			</ul>
			<strong><p>2. Credit<p></strong>
			<ul>
			...
			<li>We may collect, store and use the following kinds of personal information: 
				<ul>
					...
					<li>[information relating to any purchases you make of our [goods / services / goods and/or services] or any other transactions that you enter into through our website (including [your name, address, telephone number, email address and card details]);]</li>
			...
			<li>Your privacy settings can be used to limit the publication of your information on our website, and can be adjusted using privacy controls on the website.</li>
			...
			<li>You expressly agree to the transfers of personal information described in this Section 6.</li>
			</ul>
			<strong>7.	Retaining personal information</strong>
			<ul>
			<li>This Section 7 sets out our data retention policies and procedure, which are designed to help ensure that we comply with our legal obligations in relation to the retention and deletion of personal information.</li>
			...
			<li>Without prejudice to Section 7.2, we will usually delete personal data falling within the categories set out below at the date/time set out below: 
			<ul>
			<li>[personal data type] will be deleted [date/time; and]</li>
			<li>[repeat as necessary.]</li>
			</ul>
			</li>
			<li>Notwithstanding the other provisions of this Section 7, we will retain documents (including electronic documents) containing personal data: 
				<ul>
			<li>to the extent that we are required to do so by law;</li>
			...
			<li>in Chrome (version 41), you can block all cookies by accessing the "Customise and control" menu, and clicking "Settings", "Show advanced settings" and "Content settings", and then selecting "Block sites from setting any data" under the "Cookies" heading.</li>/
			</ul>
		</li>
			...
			<li>	in Firefox (version 36), you can delete cookies by clicking "Tools", "Options" and "Privacy", then selecting "Use custom settings for history" from the drop-down menu, clicking "Show Cookies", and then clicking "Remove All Cookies"; <li>
			...
			<ul>
			<li>This website is owned and operated by EED Advisory</li>
			<li>We are registered in Kenya under registration number CPR/2013/112912 and our registered office is at 6 Nas Court Apartments, Milimani Road, Nairobi, Kenya.</li>
			<li>Our principal place of business is in Nairobi, Kenya</li>
			<li>You can contact us by writing to the business address given above, by using our website contact form, by email to contact@eedadvisory.com or by telephone on +254 202574927</li>
			 </ul>
