...
class Profile extends FPDF {
    ...
    function summaryofEnergyUse() {
        ...
        // Header
        $header = array('FUEL', 'TOTAL CONSUMPTION', 'AVERAGE CONSUMPTION/MONTH');
        $w = array(30, 50, 70);
        ...
        $data = array(
            array("Charcoal", $total_charcoal.' Kg', $formattedNum_charcoal.' Kg'),
            array("Kerosene", $total_kerosene.' Litres', $formattedNum_kerosene.' Litres'),
            array("Firewood", $total_firewood.' Kg', $formattedNum_firewood.' Kg'),
        );
        foreach ($data as $row) {
